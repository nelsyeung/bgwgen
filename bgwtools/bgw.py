...
def create_link_files(config, dirname='.'):
    ...
    with open(file, 'a') as f:
        f.write('#!/bin/bash\n'
                ...
                'ln -sf $QE/5-wfn_fi/WFN 5-inteqp/WFN_fi\n'
                'ln -sf $QE/6-wfnq_fi/WFN 4-absorption/WFNq_fi\n'
                'ln -sf $QE/6-wfnq_fi/WFN 5-inteqp/WFNq_fi\n'
                '\n'
